                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group{{ $errors->has('information') ? ' has-error' : '' }}">
                                ...
                                <div>
                                    <textarea class="form-control" rows="8" name="information" value="" data-provide="markdown" placeholder=" Markdown">
                                        {{ old('information') ? old('information') : $group->information }}
                                    </textarea>
                                ...
                                <div>
                                    <select class="selectpicker form-control" name="color_id">
                                        @foreach( Definer::todoColor() as $id => $color)
                                            <option value="{{ $id }}" @if(old('color_id') ? old('color_id') : $group->color_id === $id) selected @endif>{{ $color }}</option>
                                        @endforeach
                                    </select>

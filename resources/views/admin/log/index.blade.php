...
<html lang="en">
  <head>
    ...
    <title>{{ trans('admin.log-viewer') }} - {{ trans('header.admin') }} - {{ config('app.title') }}</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <a href="{{ url('admin') }}" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> 戻る</a>
            </div>
        </div>
        <br>
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <h1><span class="glyphicon glyphicon-console"></span> {{ trans('admin.log-viewer') }}</h1>
        ...
        <div class="col-sm-9 col-md-10 table-container">
          ...
          @else
          <table id="table-log" class="table table-striped table-hover table-condensed">
            <thead>
              <tr>
                <th>Level</th>
                <th>Context</th>

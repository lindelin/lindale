var Clock = { template: "<div class=clock><div class=clock__hours><span class=clock__hourtime>{{hourtime}}</span> {{hours}}</div><div class=clock__minutes>{{minutes}}</div><div class=clock__seconds>{{seconds}}</div></div>",
    data: function data() {
        return {
            hours: '',
            minutes: '',
